...
/*	Enable this line to get the debug mesagges over debug uart*/
...
static void PRINTMSG_D(char *format,...);
static void PRINTMSG_B(char *format,...);
/* USER CODE END PFP */
